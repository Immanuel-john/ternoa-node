...
#[cfg(feature = "alphanet-native")]
pub type AlphanetChainSpec = sc_service::GenericChainSpec<alphanet_runtime::GenesisConfig, Extensions>;

#[cfg(not(feature = "alphanet-native"))]
pub type AlphanetChainSpec = DummyChainSpec;

#[cfg(feature = "mainnet-native")]
pub type MainnetChainSpec = sc_service::GenericChainSpec<mainnet_runtime::GenesisConfig, Extensions>;

#[cfg(not(feature = "mainnet-native"))]
pub type MainnetChainSpec = DummyChainSpec;
